    ...
    <div class="hero-wrap js-fullheight">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 col-sm-10 col-xs-8 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }"><br><br>
          ...
          <textarea name="" id="" style="padding:20px; border-radius:20px 20px 0px 0px; font-size:13px;  margin-bottom:5px; width:100%;" rows="6" placeholder="Ketik laporan ada disini..."></textarea>
